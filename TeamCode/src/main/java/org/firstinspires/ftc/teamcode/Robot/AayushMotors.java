...
public class AayushMotors {
    private HardwareMap hardwareMap;
    private Map<String, DcMotor> motorsByName = new Hashtable<>();
    private Map<Integer, DcMotor> motorsByTag = new Hashtable<>();

//-------{INITIALIZING}-----------------------------------------------------------------------------
    public AayushMotors(HardwareMap hardwareMap) {
...
//-------{ADDING MOTORS}----------------------------------------------------------------------------
    public void addAMotor(String motorName, @MotorTag int motorTag) throws Exception{
        ...
        if (this.motorsByTag.containsKey(motorTag)) {
