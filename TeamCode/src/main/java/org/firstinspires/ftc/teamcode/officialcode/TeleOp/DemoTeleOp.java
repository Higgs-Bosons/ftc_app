...
@TeleOp(name = "Demo Control", group = "TeleOp")
public class DemoTeleOp extends LinearOpMode{
    ...
    private void displayInfo(){
        if (Slow){telemetry.addData("CONTROLS SPEED ", " SLOW");}
        else{telemetry.addData("CONTROLS SPEED ", " FAST");}
        if (!LimitedMovement){telemetry.addData("CONTROLS ", " OMNI-DIRECTIONAL");}
        else{telemetry.addData("CONTROLS ", " ORTHOGONAL");}
        telemetry.addLine();
        telemetry.addData("----------CONTROLS------ ","-)");
        telemetry.addData("Turn", " Right Joystick X");
        telemetry.addData("Movement", " Left Joystick");
        telemetry.addData("Change speed", " A Button");
        telemetry.addData("Change control status", " X Button");
        telemetry.update();
