...
public class Names {
    ...
    public static final String Spinny = "Spinny";
    public static final String ArmY = "Arm-y";
    public static final String Rampy = "Rampy";
    public static final String BucketDumper = "Bucket Dumper";
}
